...
\tikzset{
  pipe/.style={rectangle, rounded corners, minimum height=17mm, text width=300mm,
    align=center, draw=kcanavy, line width=0.9pt, fill=kcanavy!7,
    font=\fontsize{19}{23}\selectfont, inner sep=3.5mm},
...
% I. 서론 > 2. 연구목표
\begin{textblock}{345}(52,455)
  \fontsize{28}{40}\selectfont\justifying
  \begin{itemize}
...
% II. 이론적 배경
\begin{textblock}{345}(50,565)
  \fontsize{27}{36}\selectfont\justifying
...
% III. 연구방법
\begin{textblock}{345}(50,778)
  \fontsize{26}{35}\selectfont\justifying
  ...
  \begin{tikzpicture}[node distance=5mm]
    \node[pipe](a){\textbf{① 사전 오염 제거}\\[0.3ex]{\fontsize{17}{21}\selectfont 광고$\cdot$기관 홍보$\cdot$봇$\cdot$비심리 상담(법률$\cdot$입시$\cdot$성형) 제거}};
    \node[pipe,below=of a](b){\textbf{② 규칙 기반 1차 분류}\\[0.3ex]{\fontsize{17}{21}\selectfont 자기/가족 주어 $+$ 상담 동사 $+$ 정신건강 어휘 $\rightarrow$ 유지/제외/검토}};
    \node[pipehi,below=of b](c){\textbf{③ LLM 판정}\\[0.3ex]{\fontsize{17}{21}\selectfont 검토 사례의 실제 경험 여부$\cdot$시점$\cdot$장면$\cdot$평가 방향$\cdot$신뢰도 산출}};
    \node[pipe,below=of c](d){\textbf{④ 보수적 본문 확정}\\[0.3ex]{\fontsize{17}{21}\selectfont 정신과$\cdot$강한 약물$\cdot$관찰자 시점 제외 $\rightarrow$ 글쓴이 본인 경험으로 한정}};
    \draw[parr](a)--(b);\draw[parr](b)--(c);\draw[parr](c)--(d);
  \end{tikzpicture}
  \end{center}
  \vspace{0mm}{\fontsize{18}{22}\selectfont\textit{그림 1.} LLM 보조 4층 정제 절차. 규칙 분류로 분량을 줄이고 경계 사례에만 LLM 판정(③)을 적용한다.}
  \par\vspace{3mm}
  \begin{center}\includegraphics[width=250mm]{../figures/corpus_funnel.pdf}\end{center}
  \vspace{0mm}{\fontsize{18}{22}\selectfont\textit{그림 2.} 원자료 3{,}652건 $\rightarrow$ 본문 코퍼스 361건(9.9\%). 관련성 유지본 479$\cdot$엄격 확정본 451건 경유.}
\end{textblock}
