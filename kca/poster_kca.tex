...
% II. 이론적 배경
\begin{textblock}{345}(56,610)
  \fontsize{28}{38}\selectfont\justifying
...
\begin{textblock}{345}(56,805)
  ...
  \end{tikzpicture}
  \end{center}
  \vspace{0mm}{\fontsize{17}{21}\selectfont\textit{그림 1.} LLM 보조 4층 정제 절차. 규칙 분류로 분량을 줄이고 경계 사례에만 LLM 판정(③)을 적용한다.}
  \par\vspace{2mm}
  \begin{center}\includegraphics[width=205mm]{../figures/corpus_funnel.pdf}\end{center}
