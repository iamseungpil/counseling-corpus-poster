...
\newcommand{\titlefs}{\fontsize{78}{86}\selectfont}
\newcommand{\authorfs}{\fontsize{34}{40}\selectfont}
\newcommand{\bodyfs}{\fontsize{25}{33}\selectfont}
\newcommand{\subhd}[1]{{\bodyfs\bfseries #1}\par\vspace{1.5mm}}
...
\begin{textblock}{345}(50,936)
  ...
  \begin{center}\includegraphics[width=215mm]{../figures/corpus_funnel.pdf}\end{center}
  \vspace{-2mm}{\fontsize{18}{22}\selectfont\textit{그림 1.} 원자료 3{,}652건이 본문 코퍼스 361건(원자료의 9.9\%)으로 좁혀지는 4층 정제 절차.}
\end{textblock}
...
\begin{textblock}{332}(455,224)
  ...
  \begin{center}\includegraphics[width=320mm]{../figures/corpus_overview.pdf}\end{center}
  ...
  \begin{center}\includegraphics[width=300mm]{../figures/process_contrast.pdf}\end{center}
